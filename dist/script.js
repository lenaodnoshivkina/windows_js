...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('.phone_link', '.popup[data-modal]', '.popup_close', modalTimerId);
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_11__["default"])('#width');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_11__["default"])('#height');
  ...
  var inputsHeightAndWidth = [].concat(_toConsumableArray(windowHeight), _toConsumableArray(windowWidth));
  inputsHeightAndWidth.forEach(function (item) {
    item.addEventListener('change', function () {
      if (state.width && state.height) {
        Object(_modal__WEBPACK_IMPORTED_MODULE_12__["default"])('.popup_calc_button', '.popup_calc_profile', '.popup_calc_profile_close', null, false);
      }
    });
  });
  ...
  windowProfile.forEach(function (item) {
    item.addEventListener('change', function () {
      if (state.profile) {
        Object(_modal__WEBPACK_IMPORTED_MODULE_12__["default"])('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', null, false);
      }
    });
  });
};
...
var images = function images() {
  ...
  if (bigImage.style.width > bigImage.style.height) {
...
function modal(triggerSelector, modalSelector, closeSelector, modalTimerId) {
  var clickOverflow = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
